...
def get_model_instance(variable_params):
    return dfdlm.DeepFusionDataLevel_m3(
...
@experiment()
def deep_fusion_data_level_m3_v1():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v1',
...
@experiment()
def deep_fusion_data_level_m3_v2():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v2',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v3():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v3',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v4():
    """ Experiment with fusion network at data level with window width 0.3s,
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v4',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v5():
    """ Experiment with fusion network at data level with window width 0.5s,
        no magnetometer data.
    """
    window_width = 0.5
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v5',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v6():
    """ Experiment with fusion network at data level with window width 1.0s,
        no magnetometer data.
    """
    window_width = 1.0
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v6',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v7():
    """ Experiment with fusion network at data level with window width 0.3s,
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v7',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v8():
    """ Experiment with fusion network at data level with window width 0.5s,
        using acc and gyr magnitude vectors.
    """
    window_width = 0.5
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v8',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m3_v9():
    """ Experiment with fusion network at data level with window width 1.0s,
        using acc and gyr magnitude vectors.
    """
    window_width = 1.0
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m3_v9',
                   manage_sequences=True,
                   use_raw_data=True,
