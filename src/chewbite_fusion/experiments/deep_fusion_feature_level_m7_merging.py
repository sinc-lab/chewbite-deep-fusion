...
def get_model_instance(variable_params):
    return dfflm.DeepFusionFeatureLevel_m7(
        ...
        merging_operation=variable_params['merge_op']
        )


@experiment()
def deep_fusion_feature_level_m7_v7_avg_merge():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_overlap=window_overlap,
                   name='deep_fusion_feature_level_m7_v7_avg_merge',
...
@experiment()
def deep_fusion_feature_level_m7_v7_max_merge():
    """ Experiment with fusion network (3 heads CNN) at feature level with window width 0.3s,
        using audio, accelerometer and gyroscope raw data.
    """
    window_width = 0.3
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_feature_level_m7_v7_max_merge',
                   manage_sequences=True,
                   use_raw_data=True,
                   model_parameters_grid={'input_size_acc': [(None, 30, 3)],
                                          'input_size_gyr': [(None, 30, 3)],
...
@experiment()
def deep_fusion_feature_level_m7_v7_mul_merge():
    """ Experiment with fusion network (3 heads CNN) at feature level with window width 0.3s,
        using audio, accelerometer and gyroscope raw data.
    """
    window_width = 0.3
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_feature_level_m7_v7_mul_merge',
                   manage_sequences=True,
                   use_raw_data=True,
                   model_parameters_grid={'input_size_acc': [(None, 30, 3)],
                                          'input_size_gyr': [(None, 30, 3)],
