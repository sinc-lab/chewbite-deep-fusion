...
@experiment()
def deep_fusion_feature_level_m7_v7_qfloat16():
    """ Experiment with fusion network (3 heads CNN) at feature level with window width 0.3s,
        using audio, accelerometer and gyroscope raw data. Quantization of float16.
    """
    window_width = 0.3
    window_overlap = 0.5
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_overlap=window_overlap,
                   name='deep_fusion_feature_level_m7_v7_qfloat16',
