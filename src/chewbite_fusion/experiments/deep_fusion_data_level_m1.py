...
def get_model_instance(variable_params):
    return dfdlm.DeepFusionDataLevel_m1(
...
@experiment()
def deep_fusion_data_level_m1_v1():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v1',
...
@experiment()
def deep_fusion_data_level_m1_v2():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v2',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v3():
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v3',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v4():
    """ Experiment with fusion network at data level with window width 0.3s,
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v4',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v5():
    """ Experiment with fusion network at data level with window width 0.5s,
        no magnetometer data.
    """
    window_width = 0.5
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v5',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v6():
    """ Experiment with fusion network at data level with window width 1.0s,
        no magnetometer data.
    """
    window_width = 1.0
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v6',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v7():
    """ Experiment with fusion network at data level with window width 0.3s,
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v7',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v8():
    """ Experiment with fusion network at data level with window width 0.5s,
        using acc and gyr magnitude vectors.
    """
    window_width = 0.5
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v8',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v9():
    """ Experiment with fusion network at data level with window width 1.0s,
        using acc and gyr magnitude vectors.
    """
    window_width = 1.0
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v9',
                   manage_sequences=True,
                   use_raw_data=True,
...
@experiment()
def deep_fusion_data_level_m1_v10():
    """ Experiment with fusion network at data level with window width 0.3s,
        using acc and gyr diff magnitude vectors.
    """
    window_width = 0.3
    window_overlap = 0.5
    X, y = main(window_width=window_width,
    ...
    e = Experiment(get_model_instance,
                   ff.FeatureFactory_AudioAccGyrDiffVectorsRawData,
                   X, y,
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v10',
                   manage_sequences=True,
                   use_raw_data=True,
                   model_parameters_grid={'input_size': [(None, 1800, 3)]})
...
@experiment()
def deep_fusion_data_level_m1_v11():
    """ Experiment with fusion network at data level with window width 0.5s,
        using acc and gyr diff magnitude vectors.
    """
    window_width = 0.5
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v11',
                   manage_sequences=True,
                   use_raw_data=True,
                   model_parameters_grid={'input_size': [(None, 3000, 3)]})
...
@experiment()
def deep_fusion_data_level_m1_v12():
    """ Experiment with fusion network at data level with window width 1.0s,
        using acc and gyr diff magnitude vectors.
    """
    window_width = 1.0
    ...
    e = Experiment(get_model_instance,
                   ...
                   window_width=window_width,
                   window_overlap=window_overlap,
                   name='deep_fusion_data_level_m1_v12',
                   manage_sequences=True,
                   use_raw_data=True,
                   model_parameters_grid={'input_size': [(None, 6000, 3)]})
